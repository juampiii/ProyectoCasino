...
public class Parejas extends JFrame implements ActionListener, IJuego
{
	static Parejas juego;
	static ICasino casino;
	private String nombreJuego = "Parejas_Simpsons";
	//matriz de botones
	...
	{
		//ficha por defecto
		vacia = new ImageIcon(Parejas.class.getResource("/Parejas_Simpsons/quien.jpg"));
		loser = new ImageIcon(Parejas.class.getResource("/Parejas_Simpsons/loser.jpg"));
		winner = new ImageIcon(Parejas.class.getResource("/Parejas_Simpsons/winner.jpg"));
		...
		for(int i=0;i<19;i++)
		{
			String cadena = "/Parejas_Simpsons/"+Integer.toString(i)+".jpg";
			System.out.println(cadena);
			foto[i] = new ImageIcon(Parejas.class.getResource(cadena));
		}
		add(nombre,"North");
