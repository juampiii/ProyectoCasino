...
public class ProyectoNuevoPersistentManager extends PersistentManager {
	private static final String PROJECT_NAME = "ProyectoNuevo";
	...
	private ProyectoNuevoPersistentManager() throws PersistentException {
	...
	public static synchronized final PersistentManager instance() throws PersistentException {
		if (_instance == null) {
			_instance = new ProyectoNuevoPersistentManager();
		}
